"""Inference pipeline for fixed-basis DCT low-frequency predictor."""
    ...
    def reconstruct_batch(self, Uels, ref_data, level):
        ...
        with torch.no_grad():
            with self._autocast_context():
                logits, _ = self.model(y_tensor, level_tensor)
