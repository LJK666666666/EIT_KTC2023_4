"""Inference pipeline for conditional spatial-mask TD16 pulmonary regression."""
    ...
    def reconstruct_batch(self, Uels, ref_data=None, level=1):
        ...
        with torch.no_grad():
            with self._autocast_context():
                sigma, _, _, _ = self.model(y_tensor, level_tensor)
