"""Inference pipeline for pulmonary atlas-plus-refinement DCT regression."""
...
class DCTSigmaHybridPredictorPipeline(BasePipeline):
    ...
    def _load_runtime_config(self):
        ...
        for key in ('input_dim', 'hidden_dims', 'level_embed_dim',
                    ...
                    'refine_channels', 'refine_seed_size'):
            if key in model_cfg:
